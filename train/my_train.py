...
from dataset.myworld import MyWorldDataset, collate_fn
from utils.training import set_seed, plot_history, sync_loss


default_args = edict({
    "data_path": "/home/student/data/RISE",
    "aug": False,
    "aug_jitter": False,
    "num_action": 20,
    "voxel_size": 0.005,
    ...
    "dropout": 0.1,
    "ckpt_dir": "/home/student/workspace/ruogu/RISE/logs/my_task",
    "resume_ckpt": None,
    "resume_epoch": -1,
    "lr": 3e-4,
    "batch_size": 240,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', action = 'store', type = str, help = 'data path', required = False, default = "/home/student/data/RISE")
    ...
    parser.add_argument('--ckpt_dir', action = 'store', type = str, help = 'checkpoint directory', required = False, default = "/home/student/workspace/ruogu/RISE/logs/my_task")
